...
% \label{fig:umap}
\centering 
\includegraphics[width=.95\linewidth]{UMAP Figure 2 Final.png}
}
\end{figure}
...
\label{fig:fig2}
\centering 
\includegraphics[scale = 0.95]{Confusion Matrix Figure 3.png}
