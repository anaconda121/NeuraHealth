...
\begin{tabular}{lccc}
        ...
        \textbf{\textit{APOE} Genotype, \emph n (\%)} \\ 
...
{\begin{tabular}{cccccc}
    ...
    \midrule
    \bfseries{\textit{APOE} ${\bm{\varepsilon}}$2} & \fseries 1754 & \fseries 0.17 & \fseries 0.83 & \fseries 0.11  \\
    \bfseries{\textit{APOE} ${\bm{\varepsilon}}$3} & \fseries 8751 & \fseries 0.17 & \fseries 0.83 & \fseries 0.11  \\
    \bfseries{\textit{APOE} ${\bm{\varepsilon}}$4} & \fseries 3436 & \fseries 0.21 & \fseries 0.79 & \fseries 0.17  \\
