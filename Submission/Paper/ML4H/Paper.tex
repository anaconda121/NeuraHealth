...
\resizebox{\columnwidth}{!}{
        \begin{tabular}{lccc}
            ...
            % \bfseries{Encounters AVG (SD)} & 14.55 (23.2) \\
            % \bfseries{Keyword Matches AVG (SD)} & 26 (54.03) \\
            \bottomrule
        \end{tabular}
}
\end{table}
...
\includegraphics[width=.75\linewidth]{UMAP Figure 2 Final.png}
}
\end{figure}
...
\centering 
\includegraphics[scale = 0.60]{APOE SLAT Overview High Resolution.png}
\caption{Overview}
...
\begin{table}[hbtp]
    ...
    \bfseries{Intact} & \fseries 0.56 & \bfseries{Experiences} & \fseries 0.36 \\
    \bfseries{Oriented} & \fseries 0.43 & \bfseries{Associations} & \fseries 0.36 \\ 
    \bfseries{Concentration} & \fseries 0.42 & \bfseries{Homicidal} & \fseries 0.36 \\ 
    \bfseries{Orientation} & \fseries 0.41 & \bfseries{Observation} & \fseries 0.36 \\
    \bfseries{Sensorium} & \fseries 0.40 & \bfseries{Knowledge} & \fseries 0.36 \\ 
    \bfseries{Perceptions} & \fseries 0.40 & \bfseries{Abstract} & \fseries 0.36 \\
    \bfseries{Judgement} & \fseries 0.39 & \bfseries{Suicidal} & \fseries 0.35 \\
    \bfseries{Fund} & \fseries 0.38 & \bfseries{Attention} & \fseries 0.35 \\
    \bfseries{Insight } & \fseries 0.36 & \bfseries{Content} & \fseries 0.34 \\ 
    \bfseries{Ideation} & \fseries 0.36 & \bfseries{Thought} & \fseries 0.34  \\  
